...
import { Counter, witnesses } from '@eddalabs/counter-contract';
...
export const createWalletAndMidnightProvider = async (walletContext) => {
    ...
    return {
        ...
        async balanceTx(tx, newCoins, ttl) {
...
export const initWalletWithSeed = async (seed, config) => {
    ...
    const walletConfiguration = {
        ...
        costParameters: {
            additionalFeeOverhead: 300000000000000n, // 300 trillion - matches SDK examples
            feeBlocksMargin: 5,
        },
    ...
    const dustWallet = DustWallet(walletConfiguration).startWithSecretKey(dustSecretKey, ledger.LedgerParameters.initialParameters().dust);
