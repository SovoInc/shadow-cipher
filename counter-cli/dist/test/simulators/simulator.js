import { UndeployedConfig, currentDir, PreviewConfig } from '../../config';
...
export class TestEnvironment {
    ...
    static getProofServerContainer = async (env) => await new GenericContainer('midnightnetwork/proof-server:6.1.0-alpha.6')
