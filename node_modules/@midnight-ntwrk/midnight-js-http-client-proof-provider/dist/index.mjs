import { createProvingTransactionPayload, Transaction } from '@midnight-ntwrk/ledger-v6';
...
const deserializePayload = (arrayBuffer) => {
...
const serializeTransactionPayload = (unprovenTx, zkConfig) => {
    const map = new Map();
    if (zkConfig) {
...
export { DEFAULT_CONFIG, httpClientProofProvider, serializeTransactionPayload };
