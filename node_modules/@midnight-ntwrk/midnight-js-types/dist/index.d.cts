...
import { FinalizedTransaction, TransactionId, Transaction, SignatureEnabled, Proof, Binding, TransactionHash, ContractAddress, IntentHash, RawTokenType, PreBinding, UnprovenTransaction, ZswapChainState, ShieldedCoinInfo, CoinPublicKey, EncPublicKey } from '@midnight-ntwrk/ledger-v6';
...
type BalancedProvingRecipe = ProvingRecipe<UnprovenTransaction | FinalizedTransaction>;
/**
