...
const deserializeZswapState = (s) => ledgerV6.ZswapChainState.deserialize(toByteArray(s));
const deserializeTransaction = (s) => ledgerV6.Transaction.deserialize('signature', 'proof', 'binding', toByteArray(s));
