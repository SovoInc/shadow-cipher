...
function __wbg_adapter_64(arg0, arg1, arg2) {
    wasm.closure2349_externref_shim(arg0, arg1, arg2);
}

function __wbg_adapter_792(arg0, arg1, arg2, arg3) {
    wasm.closure2394_externref_shim(arg0, arg1, arg2, arg3);
}

function __wbg_adapter_835(arg0, arg1, arg2, arg3, arg4) {
    wasm.closure2398_externref_shim(arg0, arg1, arg2, arg3, arg4);
}
...
export class ClaimRewardsTransaction {
     ...
     * @param {any} signature
     */
    constructor(signature_marker, network_id, value, owner, nonce, signature) {
        ...
        const ret = wasm.claimrewardstransaction_new(ptr0, len0, ptr1, len1, value, ptr2, len2, ptr3, len3, signature);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
...
export class LedgerState {
     ...
     * @returns {LedgerState}
     */
    postBlockUpdate(tblock, fullness) {
        const ret = wasm.ledgerstate_postBlockUpdate(this.__wbg_ptr, tblock, fullness);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
...
export class ZswapInput {
    ...
    static newContractOwned(coin, segment, contract, state) {
        ...
        const len0 = WASM_VECTOR_LEN;
        _assertClass(state, ZswapChainState);
        const ret = wasm.zswapinput_newContractOwned(coin, segment, ptr0, len0, state.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
...
export class ZswapLocalState {
    ...
    spend(secret_keys, coin, segment, _ttl) {
        _assertClass(secret_keys, ZswapSecretKeys);
        const ret = wasm.zswaplocalstate_spend(this.__wbg_ptr, secret_keys.__wbg_ptr, coin, segment, isLikeNone(_ttl) ? 0 : addToExternrefTable0(_ttl));
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    spendFromOutput(secret_keys, coin, segment, output, _ttl) {
        ...
        const ret = wasm.zswaplocalstate_spendFromOutput(this.__wbg_ptr, secret_keys.__wbg_ptr, coin, segment, output.__wbg_ptr, isLikeNone(_ttl) ? 0 : addToExternrefTable0(_ttl));
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
export class ZswapOffer {
    ...
    static fromInput(input, type_, value) {
        ...
        const ptr0 = passStringToWasm0(type_, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.zswapoffer_fromInput(input.__wbg_ptr, ptr0, len0, value, value >> BigInt(64));
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    static fromOutput(output, type_, value) {
        ...
        const ptr0 = passStringToWasm0(type_, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.zswapoffer_fromOutput(output.__wbg_ptr, ptr0, len0, value, value >> BigInt(64));
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ZswapOffer.__wrap(ret[0]);
...
export class ZswapOutput {
    ...
    static new(coin, segment, target_cpk, target_epk) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.zswapoutput_new(coin, segment, ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    static newContractOwned(coin, segment, contract) {
        const ptr0 = passStringToWasm0(contract, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.zswapoutput_newContractOwned(coin, segment, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ZswapOutput.__wrap(ret[0]);
...
export class ZswapTransient {
    ...
    static newFromContractOwnedOutput(coin, segment, output) {
        _assertClass(output, ZswapOutput);
        const ret = wasm.zswaptransient_newFromContractOwnedOutput(coin, segment, output.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
...
export function __wbg_forEach_432d981ecbee7d69(arg0, arg1, arg2) {
    try {
        ...
        var cb0 = (arg0, arg1, arg2) => {
            ...
            state0.a = 0;
            try {
                return __wbg_adapter_835(a, state0.b, arg0, arg1, arg2);
            } finally {
                state0.a = a;
            }
        };
...
export function __wbg_keys_4e7df9a04572b339(arg0) {
    const ret = arg0.keys();
    return ret;
};
...
export function __wbg_setTime_8afa2faa26e7eb59(arg0, arg1) {
...
export function __wbindgen_closure_wrapper31110(arg0, arg1, arg2) {
    const ret = makeMutClosure(arg0, arg1, 2350, __wbg_adapter_64);
    return ret;
};
