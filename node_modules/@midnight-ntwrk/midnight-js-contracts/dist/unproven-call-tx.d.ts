...
export declare function createUnprovenCallTx<C extends Contract<undefined>, ICK extends ImpureCircuitId<C>>(providers: UnprovenCallTxProvidersBase, options: CallTxOptionsBase<C, ICK>, transactionContext?: TransactionContext<C, ICK>): Promise<UnsubmittedCallTxData<C, ICK>>;
export declare function createUnprovenCallTx<C extends Contract, ICK extends ImpureCircuitId<C>>(providers: UnprovenCallTxProvidersWithPrivateState<C>, options: CallTxOptionsWithPrivateStateId<C, ICK>, transactionContext?: TransactionContext<C, ICK>): Promise<UnsubmittedCallTxData<C, ICK>>;
