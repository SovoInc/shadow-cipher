...
export declare function submitCallTx<C extends Contract, ICK extends ImpureCircuitId<C>>(providers: ContractProviders<C>, options: CallTxOptionsWithPrivateStateId<C, ICK>, transactionContext: TransactionContext<C, ICK>): Promise<CallResult<C, ICK>>;
export declare function submitCallTx<C extends Contract<undefined>, ICK extends ImpureCircuitId<C>>(providers: SubmitTxProviders<C, ICK>, options: CallTxOptionsBase<C, ICK>, transactionContext: TransactionContext<C, ICK>): Promise<CallResult<C, ICK>>;
/**
 ...
 * ```
 */
export declare function submitCallTxAsync<C extends Contract, ICK extends ImpureCircuitId<C>>(providers: SubmitCallTxProviders<C, ICK>, options: CallTxOptions<C, ICK>): Promise<SubmittedCallTx<C, ICK>>;
