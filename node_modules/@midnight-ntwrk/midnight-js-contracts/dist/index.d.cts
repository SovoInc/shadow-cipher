import { ContractAddress, CoinPublicKey, ContractState, StateValue, Op, AlignedValue, ZswapLocalState, ShieldedCoinInfo, SigningKey } from '@midnight-ntwrk/compact-runtime';
import { ZswapChainState, PartitionedTranscript, ContractAddress as ContractAddress$1, UnprovenTransaction, ShieldedCoinInfo as ShieldedCoinInfo$1, EncPublicKey, SigningKey as SigningKey$1 } from '@midnight-ntwrk/ledger-v6';
import { Contract, ImpureCircuitId, CircuitParameters, PrivateState, CircuitReturnType, InitialStateParameters, MidnightProviders, PrivateStateId, PublicDataProvider, PrivateStateProvider, FinalizedTxData, VerifierKey, UnshieldedBalances } from '@midnight-ntwrk/midnight-js-types';
 ...
 */
declare const submitTxAsync: <C extends Contract, ICK extends ImpureCircuitId<C>>(providers: SubmitTxProviders<C, ICK>, options: SubmitTxOptions<ICK>) => Promise<string>;
 ...
 */
type SubmittedCallTx<C extends Contract, ICK extends ImpureCircuitId<C>> = {
    /**
 ...
 */
interface TransactionContext<C extends Contract, ICK extends ImpureCircuitId = ImpureCircuitId> {
    ...
    readonly [CacheStates]: (states: ContractStates<PrivateState<C>> | PublicContractStates) => void;
    /**
 ...
 */
declare const withContractScopedTransaction: <C extends Contract, ICK extends ImpureCircuitId = ImpureCircuitId>(providers: ContractProviders<C, ICK>, fn: (txCtx: TransactionContext<C, ICK>) => Promise<void>, options?: ScopedTransactionOptions) => Promise<FinalizedCallTxData<C, ICK>>;
...
declare function createUnprovenCallTx<C extends Contract<undefined>, ICK extends ImpureCircuitId<C>>(providers: UnprovenCallTxProvidersBase, options: CallTxOptionsBase<C, ICK>, transactionContext?: TransactionContext<C, ICK>): Promise<UnsubmittedCallTxData<C, ICK>>;
declare function createUnprovenCallTx<C extends Contract, ICK extends ImpureCircuitId<C>>(providers: UnprovenCallTxProvidersWithPrivateState<C>, options: CallTxOptionsWithPrivateStateId<C, ICK>, transactionContext?: TransactionContext<C, ICK>): Promise<UnsubmittedCallTxData<C, ICK>>;
...
type CircuitCallTxInterface<C extends Contract> = {
    [ICK in ImpureCircuitId<C>]: {
        ...
        (txCtx: TransactionContext<C, ICK>, ...args: CircuitParameters<C, ICK>): Promise<CallResult<C, ICK>>;
    };
};
/**
...
declare class TxFailedError extends Error {
    ...
    readonly circuitId?: (ImpureCircuitId | ImpureCircuitId[]) | undefined;
    /**
     ...
     *                  failed.
     */
    constructor(finalizedTxData: FinalizedTxData, circuitId?: (ImpureCircuitId | ImpureCircuitId[]) | undefined);
}
/**
...
type SubmitCallTxProviders<C extends Contract, ICK extends ImpureCircuitId<C>> = ContractProviders<C> | SubmitTxProviders<C, ICK>;
...
declare function submitCallTx<C extends Contract, ICK extends ImpureCircuitId<C>>(providers: ContractProviders<C>, options: CallTxOptionsWithPrivateStateId<C, ICK>, transactionContext: TransactionContext<C, ICK>): Promise<CallResult<C, ICK>>;
declare function submitCallTx<C extends Contract<undefined>, ICK extends ImpureCircuitId<C>>(providers: SubmitTxProviders<C, ICK>, options: CallTxOptionsBase<C, ICK>, transactionContext: TransactionContext<C, ICK>): Promise<CallResult<C, ICK>>;
/**
 ...
 * ```
 */
declare function submitCallTxAsync<C extends Contract, ICK extends ImpureCircuitId<C>>(providers: SubmitCallTxProviders<C, ICK>, options: CallTxOptions<C, ICK>): Promise<SubmittedCallTx<C, ICK>>;
