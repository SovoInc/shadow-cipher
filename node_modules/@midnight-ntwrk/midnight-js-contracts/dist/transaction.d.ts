 ...
 */
export interface TransactionContext<C extends Contract, ICK extends ImpureCircuitId = ImpureCircuitId> {
 ...
 */
export declare const isTransactionContext: (u: unknown) => u is TransactionContext<Contract>;
/**
 ...
 */
export declare const withContractScopedTransaction: <C extends Contract, ICK extends ImpureCircuitId = ImpureCircuitId>(providers: ContractProviders<C, ICK>, fn: (txCtx: TransactionContext<C, ICK>) => Promise<void>, options?: ScopedTransactionOptions) => Promise<FinalizedCallTxData<C, ICK>>;
