 ...
 */
export declare const submitTxAsync: <C extends Contract, ICK extends ImpureCircuitId<C>>(providers: SubmitTxProviders<C, ICK>, options: SubmitTxOptions<ICK>) => Promise<string>;
